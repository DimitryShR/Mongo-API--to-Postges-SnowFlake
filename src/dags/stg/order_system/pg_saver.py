...
class PgSaver:
    ...
    def save_restaurant_object(self, conn: Connection, id: str, update_ts: datetime, val: Any):
    ...
    def save_user_object(self, conn: Connection, id: str, update_ts: datetime, val: Any):
        str_val = json2str(val)
        with conn.cursor() as cur:
            cur.execute(
                """
    ...
    def save_order_object(self, conn: Connection, id: str, update_ts: datetime, val: Any):
        str_val = json2str(val)
        with conn.cursor() as cur:
            cur.execute(
                """
